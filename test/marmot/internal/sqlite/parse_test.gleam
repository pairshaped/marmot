...
pub fn infer_cast_integer_test() {
  let result =
    infer_expression_type(
      cast_item("id", [Word("id"), Word("AS"), Word("INTEGER"), CloseParen]),
    )
...
pub fn infer_cast_int_alias_test() {
  let result =
    infer_expression_type(
      cast_item("id", [Word("id"), Word("AS"), Word("INT"), CloseParen]),
    )
  let assert Column(name: "id", column_type: IntType, nullable: False) = result
}
...
pub fn infer_cast_bigint_test() {
  let result =
    infer_expression_type(
      cast_item("id", [Word("id"), Word("AS"), Word("BIGINT"), CloseParen]),
    )
  let assert Column(name: "id", column_type: IntType, nullable: False) = result
}
...
pub fn infer_cast_real_test() {
  let result =
    infer_expression_type(
      cast_item("val", [Word("val"), Word("AS"), Word("REAL"), CloseParen]),
    )
  let assert Column(name: "val", column_type: FloatType, nullable: False) =
    result
}
...
pub fn infer_coalesce_string_literal_test() {
  let result =
    infer_expression_type(
      coalesce_item("name", [Word("name"), Comma, StringLit("unknown")]),
    )
  let assert Column(name: "name", column_type: StringType, nullable: False) =
    result
}
...
pub fn infer_coalesce_integer_literal_test() {
  let result =
    infer_expression_type(
      coalesce_item("cnt", [Word("count"), Comma, Number("0")]),
    )
...
pub fn infer_coalesce_float_literal_test() {
  let result =
    infer_expression_type(
      coalesce_item("val", [Word("val"), Comma, Number("3.14")]),
    )
  let assert Column(name: "val", column_type: FloatType, nullable: False) =
    result
}
...
pub fn infer_coalesce_last_arg_null_test() {
  let result =
    infer_expression_type(
      coalesce_item("val", [Word("val"), Comma, Word("NULL")]),
    )
...
pub fn infer_coalesce_column_ref_last_test() {
  let result =
    infer_expression_type(coalesce_item("name", [Word("a"), Comma, Word("b")]))
...
pub fn infer_coalesce_empty_test() {
  ...
  let assert Column(name: "empty", column_type: StringType, nullable: True) =
    result
}
...
pub fn infer_expr_unknown_function_test() {
  let item =
    item("foo", [Word("UNKNOWN_FUNC"), OpenParen, Word("arg"), CloseParen])
